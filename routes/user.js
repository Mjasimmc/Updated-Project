...
router.get('/product/:id', search.productGet, sessioncheck.result, userController.not_logged_browse_Product)
...
router.get('/product-home/:id', search.productLook, sessioncheck.homeallow, block, userController.logged_browse_product)
...
router.get('/list-orders', sessioncheck.homeallow, block, userController.list_orders)

router.get('/view-wishlist', sessioncheck.homeallow, block, userController.view_wish_list)
